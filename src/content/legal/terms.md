...
SnapOps AI is a customer relationship management (CRM) platform for wedding and creative studio businesses, providing tools for lead management, project tracking, deliverables management, and payment tracking, among other features.

## 2. Eligibility
You must be at least 18 years old and capable of entering into a binding contract under the Indian Contract Act, 1872, to use the Service. By using the Service, you represent that you meet this requirement.
...
- The Service, including its software, design, and branding, is owned by SnapOps and protected by applicable intellectual property laws.
- These Terms do not grant you any rights to our trademarks, logos, or brand assets.

## 8. Third-Party Services
The Service may integrate with third-party tools (e.g., payment processors, communication platforms). Your use of such integrations may be subject to the third party's own terms.
